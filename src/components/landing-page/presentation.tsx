import { Package, ClipboardCheck, BellRing, Key, CheckCircle, BarChart2 } from "lucide-react";
...
export function Presentation() {
  const steps = [
    ...
    },
    {
      icon: BellRing,
      title: "Notificação",
      description: "O morador recebe alerta com os dados e o código de retirada."
    },
    {
      icon: Key,
      title: "Código de Resgate",
      description: "Basta informar o código na portaria para liberar a entrega."
    },
    {
      icon: ClipboardCheck,
    ...
    },
    {
      ...
      description: "O porteiro visualiza pendências e relatórios em tempo real."
    },
  ];
  ...
  return (
    <section className="flex flex-col gap-4 px-8 pb-8 pt-14 items-center">
      <h3 className="text-foreground font-semibold text-4xl text-center mb-10">
        Como <strong className="text-primary font-semibold">funciona</strong> a nossa solução?
      </h3>
