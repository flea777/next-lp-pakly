...
export function Hero() {
  ...
  return (
    <section className="flex flex-col gap-8 justify-center items-center min-h-[380px] pt-8">
      <div className="flex flex-col gap-8 px-12 items-center">
        <h2
          className={`text-7xl font-bold text-center text-primary max-w-3/4 ${lora.className}`}
        >
          Simplifique a{' '}
